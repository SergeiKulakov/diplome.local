<?php
  ...
  class AdminModel extends DataBase {
    ...
    public static function viewAllAdmins() {
      $sql = "SELECT a.*, r.title status FROM admin a JOIN roles r ON r.id=a.role_id ORDER BY a.id DESC";
    ...
    public static function viewAdmin($id) {
      $sql = "SELECT a.*, r.title title_role, r.id id_role FROM admin a JOIN roles r ON r.id = a.role_id WHERE a.id = ?";
      $sth = self::DB()->prepare($sql);
